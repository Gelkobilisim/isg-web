...
const LoginScreen = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      setLoginErr("Sunucuya bağlanılamadı. Lütfen tekrar deneyin.");
      triggerHaptic("error");
    }
  };
...
const AdminDashboard = () => {
  ...
  const confirmUpdateUser = async () => {
    ...
    // Sifreyi ayri guncelle
    await setDoc(doc(db, "user_secrets", userToUpdate), { password: editUserForm.password }, { merge: true });
